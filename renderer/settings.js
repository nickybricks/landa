...
const TRANSLATIONS = {
  en: {
    ...
    'modes.preview.notes.smart': 'Project kickoff\n- Confirm budget with finance\n- Draft timeline by Friday\n- Share brief with the team',
  ...
  de: {
    ...
    'modes.preview.email.formal': 'Hallo Oscar,\n\nvielen Dank für die Q3-Zahlen. Ich habe sie durchgesehen und hätte ein paar Fragen zur Prognose — hätten wir diese Woche 15 Minuten Zeit, sie gemeinsam durchzugehen?\n\nMit freundlichen Grüßen\nLotti',
    'modes.preview.email.casual': 'Hi Oscar,\n\ndanke für die Q3-Zahlen, ich hab schon mal reingeschaut. Hätte ein paar Fragen zur Prognose — diese Woche 15 Minuten Zeit?\n\nBeste Grüße\nLotti',
    'modes.preview.email.excited': 'Hi Oscar,\n\ndanke für die Q3-Zahlen — die sehen super aus! Ich hab noch ein paar kurze Fragen zur Prognose. Hätten wir diese Woche vielleicht 15 Minuten Zeit?\n\nBeste Grüße\nLotti',
    'modes.preview.notes.smart': 'Projekt-Kickoff\n- Budget mit der Finanzabteilung klären\n- Zeitplan bis Freitag entwerfen\n- Briefing mit dem Team teilen',
